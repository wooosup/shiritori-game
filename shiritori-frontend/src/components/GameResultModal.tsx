  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      <div className="relative w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900 dark:text-slate-100">
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-gray-200 bg-gradient-to-b from-white to-gray-50 p-4 dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="mt-3 space-y-3 max-h-48 overflow-y-auto pr-1">
            {words.map((wordEntry) => (
              <div
                key={wordEntry.word}
                className="flex items-center justify-between rounded-xl border border-gray-100 bg-white p-3 text-sm font-bold text-gray-700 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
              >
                <div>
                  <div className="text-lg">{wordEntry.word}</div>
